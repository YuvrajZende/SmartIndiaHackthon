...
const Index = () => {
  const handleGetStarted = () => {
    // This would navigate to the main application
    console.log("Navigate to main application");
  };
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">
              How <span className="text-aqua-bright">OceanGPT</span> Works
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <WorkflowStep
              ...
              icon={<MessageCircle />}
              title="Chat"
              description="Have natural conversations with OceanGPT to explore insights and ask questions"
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <FeatureCard
              icon="🤖"
              title="Natural Conversation with OceanGPT"
      ...
      <footer className="py-16 px-6 bg-ocean-deep border-t border-ocean-light/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-aqua-bright mb-4">OceanGPT</h3>
          ...
          <div className="mt-12 pt-8 border-t border-ocean-light/20 text-center">
            <p className="text-muted-foreground text-sm">
              © 2024 OceanGPT. Exploring the depths of ocean data with artificial intelligence.
            </p>
          </div>
        </div>
      </footer>
